...
$analyzer$ is the socket descriptor of the analysis server, when some connection
...
\node (analysis) [rectangle, draw, thick, rounded corners=3pt, text width = 100pt, below= 1cm of internet, fill=red!50] {Analysis server};
