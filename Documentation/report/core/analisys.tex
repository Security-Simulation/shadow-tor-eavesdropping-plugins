...
After a bunch of simulation runs handled as previously explained, we performed a data analysis in order to
figure out the effectiveness of a time analysis attack.  
In this section we will illustrate the software tools we used in the
analysis phase and eventually we will present the empirical results
obtained.
